...
function LandingPage() {
    ...
    return (
        ...
        >
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <motion.div variants={fadeInUp} className="mb-4 sm:mb-6">
                            <span className="inline-flex items-center px-2 py-1 sm:px-3 rounded-full text-xs sm:text-sm font-medium mb-4"
                                style={{
                        ...
                        <motion.p
                            ...
                            style={{ color: 'var(--muted-foreground)' }}
                        >
                            Transform your PDF documents into interactive conversations. Upload, ask questions,
                            and get instant answers powered by advanced AI technology.
                        </motion.p>
            ...
            {/* Features Section */}
            <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-8 md:py-20 lg:px-12 xl:px-20" style={{ backgroundColor: 'var(--muted)' }}>
                <div className="max-w-7xl mx-auto">
                    <motion.div
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl max-w-xs sm:max-w-xl lg:max-w-2xl mx-auto px-4"
                            style={{ color: 'var(--muted-foreground)' }}
                        >
            ...
            {/* Footer */}
            <footer className="px-4 py-8 sm:px-6 sm:py-10 md:px-8 md:py-12 lg:px-12 xl:px-20"
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-lg sm:text-xl font-bold">PDF Chatter</span>
                        </div>
                        <p className="text-xs sm:text-sm text-center" style={{ color: 'var(--muted-foreground)' }}>
                            © 2025 PDF Chatter. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
